...
public class ExistingVIPBookingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_existingvipbooking, container, false);
    }
    ...
    public void onViewCreated(@NonNull android.view.View view, @Nullable Bundle savedInstanceState) {
        ...
        userprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_navigation_exisitingvipbook_to_navigation_profile);
            }
        });
