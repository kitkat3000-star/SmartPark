    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        dREF.addSnapshotListener(getActivity(), new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                SREF = Fstore.collection("Users").document(userID).collection("Reciepts").document();
                Map<String, String> Reciepts = new HashMap<String, String>();
                Reciepts.put("Location", Location);
                Reciepts.put("Date", Date);
                Reciepts.put("Time", Time);
                Reciepts.put("Duration", Duration);
                SREF.set(Reciepts);
                SREF.update("Amount",Amount,"VAT",VAT,"Total Bill",Totalbill,"Service charges",servicecharges);
            }
        });
